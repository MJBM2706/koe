...
if(isset($_POST['updateVoluntario'])){
  $nombre = $_POST['nombre'];
  ...
  if (empty($nombre)
    ...
    or empty($estadoCapacitacion)
        ...
        if ($errores == ''){
          $actualizar=$metodosBD->actualizarVoluntario($idUsuario,$nombre,$apellido,$tipoDocumento,$documento,$fechaNacimiento,$departamento,$ciudad,$direccion,$celular,$ocupacion,$estadoCapacitacion);
        if ($actualizar) {
...
<body>
  ...
  <div class="contenedor">
    <div class="container">
      <h4><a style="margin-right: 15px;" href="inicio.php"><img src="../../icons/back-track.png" alt="Ir atrás"></a>Detalle Voluntario</h4>
      <hr>
      <form action="" method="post" class="profile-form">
        <?php
          $resultado = $metodosBD->consultarUsuario($idUsuario);
            ...
            $resultado = $metodosBD->consultarVoluntario($idUsuario);
            if(mysqli_num_rows($resultado) > 0){
              while ($row = mysqli_fetch_assoc($resultado)){
            ?>
            <li>
            ...
            <li>
              ...
              <input type="text" name="documento" value="<?php echo $row['documento'] ?>" required>
            </li>
            <li>
            ...
            <li>
              <label for="ocupacion">Tarjeta Profesional</label>
            ...
            <li>
              ...
              <select class="profile-form-option" name="estadoCapacitacion" id="" required>
                <option value="<?php echo $row['estadoCapacitacion'] ?>"><?php echo $row['estadoCapacitacion'] ?></option>
        ...
        <div class="profile-form">
          <input type="submit" name="updateVoluntario" value="Actualizar Voluntario">
