...
if(isset($_POST['add'])){
  ...
  $nombre = $_POST['nombre'];
    ...
    or empty($estadoTarjeta)
        ...
        if ($errores == ''){
          $nuevo=$metodosBD->crearUsuarioProfesional($correo,$password);
          $usuario=$metodosBD->consultarIdUsuario($correo,$password);
          $idUsuario = (int)$usuario[0]['idUsuario'];
          $aux = $metodosBD->crearProfesional($idUsuario,$nombre,$apellido,$tipoDocumento,$documento,$fechaNacimiento,$departamento,$ciudad,$direccion,$celular,$tituloProfesional,$tarjetaProfesional,$estadoTarjeta);
        if ($aux) {
        ...
        <div>
          <ul class="profile-info contact-info">
            ...
            <li>
              ...
              <input type="text" name="tituloProfesional" required>
            </li>
            <li>
              <label for="tarjetaProfesional">Tarjeta Profesional</label>
              <input type="text" name="tarjetaProfesional" required>
            </li>
            <li>
